		...
		$result = mysqli_query($connect,$sql);
			...
			if (mysqli_num_rows ($result) >0 )
			{
				while($row=mysqli_fetch_array($result))
				{
					...
					echo '<br><br><a href="page3.php?action='.$row[0].'"><h2 style="margin-left:200px">Add to Cart</h2></a>';
					echo '<a href="index1.php"><h2 style="margin-left:360px;margin-top:-23px">Cancel</h2></a>';
				}
			}
	?>
