...
<div id="container">
	...
	<img width="8%" src="images/logo.png" alt="web developer directory">
		...
		<a href="cart.php"><img width="3%" src="cart.png" style="margin-left:600px;margin-top:-30px;"></a>
		...
		<?php
			...
			if(isset($_SESSION['isloggedin']) && $_SESSION['isloggedin']) 
			{
				...
				echo '<a href="order.php"><div class="ab" style="position:absolute;margin-left:780px;width:100px;margin-top:-16px;">My Orders</div></a>';
				echo '<a href="session_destroy.php"><div class="ab" style="position:absolute;margin-left:880px;margin-top:-15px;">Logout</div></a>';
			}
			else
			{
