...
<div id="container">
	...
	<div id="content">
		...
		<?php
			$sql = "SELECT * FROM books WHERE Category in ('Romance','Children','Entertainment')";
		    $result = mysqli_query($connect,$sql);

			if($result!=false){
			if (mysqli_num_rows ($result) >0 )
			{
				echo '<br><br><br><br><h2 style="text-transform: uppercase;text-align:center;color:#1C478E">Fiction Books<br></h2>';
			...
			{
				echo '<br><br><br><h2 style="color:#1C478E;text-transform:uppercase;text-align:center">No Fiction books available </h2>';
			}
			}
		?>
