...
<div id="container">
	...
	<div id="content">
		...
		if (isset($_GET['action'])) {
			$var=$_GET['action'];
			$sql = "SELECT * FROM books WHERE Category like '%$var%'";
		    $result = mysqli_query($connect,$sql);

			if($result!=false){
			if (mysqli_num_rows ($result) >0 )
			{
				echo '<br><br><br><br><h2 style="text-transform: uppercase;text-align:center;color:#1C478E">Books found of category "'.$var.'"<br></h2>';
