	...
	<form action="page11.php" method="post">
		...
		if (isset($_GET['action'])) {
			...
			if (mysqli_num_rows ($result) >0 )
			{
				...
				{
					echo '<br><br><br><br><br>';
					echo '<img style="float:left;overflow: auto display:inline" align=top width=30% class="abc" src="'.$row[9].'">';
					...
					echo '<br><br><div style="margin-left:40px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Description</b> : '.$row[7].'</div>';
					echo '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Shopname</b> : '.$row[6];
					echo '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Cost</b> : Rs'.$row[8];
					echo '<br style="clear:left;display:inline;";><br><br><br></div>';
				}
			}
