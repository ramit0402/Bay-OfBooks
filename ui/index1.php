	...
	<img width="8%" src="images/logo.png" alt="web developer directory">
	 ...
	 <div id="leftmenu" style="margin-top:15px";>
       ...
       <ul>
            ...
            <li><a href="browse1.php?action=College Text & Reference">College Text & Reference</a></li>
            <li><a href="browse1.php?action=Computer & Internet">Computer & Internet</a></li>
            <li><a href="browse1.php?action=Cooking">Cooking</a></li>
            <li><a href="browse1.php?action=Educational & Professional">Educational & Professional</a></li>
