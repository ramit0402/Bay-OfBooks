	...
	<div id="content" >
		...
		if (mysqli_num_rows ($result) >0 )
		{
			...
			while($row=mysqli_fetch_array($result))
			{
				...
				echo '<br><br><b><a href="buy.php?action='.$row[0].'" style="margin-left:40px">Buy</b>';
				echo '<br><br><b><a href="remove.php?action='.$row[0].'" style="margin-left:40px">Remove</a></b></td>';
				$total+=($row[13]*$row[4]);
				$r++;
				if ($r%2==0)
					echo '</tr>';
		...
		echo '<br><h3 style="margin-left:102px;text-transform: uppercase"><a href="buyall.php"> Buy All </a></h3>';
		}
		?>
	</div>
	</div>
