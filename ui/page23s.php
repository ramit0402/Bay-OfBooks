...
<div id="container">
 ...
 <ul class="menu">
		...
		if (isset($_GET['action'])) {
			...
			if (mysqli_num_rows ($result) >0 )
			{
				while($row=mysqli_fetch_array($result))
				{
					...
					echo '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Cost</b> : Rs'.$row[8];
					echo '<br style="clear:left;display:inline;";><br></div>';
				}
			}
	...
	<form action="page24s.php" method="post">
	<label style="margin-left:285px;"><b>Quantity</b></label>
    <input type="number" style="margin-left:360px;margin-top:-17px;width:120px" placeholder="Enter Quantity" name="quantity" required><br>
	<button class="c" style="margin-left:290px" type="submit" name="Submit">Select</button>
